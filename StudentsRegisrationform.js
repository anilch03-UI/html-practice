document.addEventListener('DOMContentLoaded', () => {
    ...
    const fatherNameInput = document.getElementById('fatherName'); // Added reference for father's name input
    ...
    const fatherNameError = document.getElementById('fatherNameError'); // Added reference for father's name error span
    ...
    function validateForm() {
        ...
        // 8. Father's Name Validation (optional, but if provided, must be at least 3 characters)
        if (fatherNameInput.value.trim() !== '' && fatherNameInput.value.trim().length < 3) {
            displayError(fatherNameError, "Father's Name must be at least 3 characters if provided.");
            isValid = false;
        } else {
    ...
    myForm.addEventListener('submit', (event) => {
        ...
        if (validateForm()) {
            ...
            const formData = {
                ...
                fatherName: fatherNameInput.value.trim() || null, // Include father's name in form data
